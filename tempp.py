...
# from django.db import connection //for backend
...
class Employee:
    def __init__(self, root):
        ...
        combo_dep=ttk.Combobox(upper_frame,textvariable=self.var_dep,font=('arial',11,'bold'),width=20,state='readonly') #readonly because we can't edit
        ...
        txt_designi=DateEntry(upper_frame,selectmode='day',textvariable=self.var_dob,width=20,font=('areal',11,'bold')) #insering calandar
        txt_designi.grid(row=3,column=1,sticky=W,padx=2,pady=7)
        dt=date(2022,10,8)
        ...
        combo_mar=ttk.Combobox(upper_frame,textvariable=self.var_married,font=('arial',11,'bold'),width=20,state='readonly') #readonly because we can't edit
        ...
        lbl_DOJ=Label(upper_frame,font=('areal',12,'bold'),text='Date of Joining:',bg='white') #insering calandar
